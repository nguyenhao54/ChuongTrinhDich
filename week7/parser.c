...
{
  // DONE: parse a lvalue (a variable, an array element,
  //                      a parameter, the current function identifier)
  Object *var;
  Type *varType;
...
void compileForSt(void)
{
  ...
  checkTypeEquality(type, varType);
  eat(KW_TO);
  type = compileExpression();
  checkTypeEquality(type, varType);
  eat(KW_DO);
...
void compileArgument(Object *param)
{
  ...
  //       If the corresponding parameter is a reference,
  // the argument must be a lvalue
  {
    type = compileLValue();
  }
  else // PARAM_VALUE
...
{
  // DONE: parse a list of arguments,
  ...
  case SB_LPAR:
    ...
    // check the consistency of the arguments and the given parameters
...
Type *compileFactor(void)
{
  ...
  case TK_IDENT:
    ...
    case OBJ_VARIABLE:
      ...
      {
        // if factor is an array variable
...
{
  // DONE: parse a sequence of indexes,
  // check the consistency to the arrayType,
