...
{
  // DONE: create and declare a function object
  Object *funcObj;
  eat(KW_FUNCTION);
  eat(TK_IDENT);
...
{
  // DONE: create and return an unsigned constant value
  ...
  case TK_IDENT:
    ...
    // (ERR_UNDECLARED_INT_CONSTANT, currentToken->lineNo, currentToken->colNo);
    break;
    break;
  case TK_CHAR:
    eat(TK_CHAR);
